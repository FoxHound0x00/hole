# Model: ConvNeXt_Large_Weights.IMAGENET1K_V1
import os
import torch
...
MODEL_PATH = "../finetune/convnext_l_cifar10.pth"
OUTPUT_DIR = "hole_outputs/convnext_l"
...
# Load model
print("Loading finetuned ConvNeXt-Large...")
...
fig = blob_viz.plot_pca_with_cluster_hulls(
    ...
    title=f"ConvNeXt-Large - Threshold: {middle_threshold:.3f}",
)
plt.close(fig)
