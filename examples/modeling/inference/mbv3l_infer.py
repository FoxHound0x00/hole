# Model: MobileNet_V3_Large_Weights.IMAGENET1K_V1
import os
import torch
...
MODEL_PATH = "../finetune/mbv3l_cifar10.pth"
OUTPUT_DIR = "hole_outputs/mbv3l"
...
# Load model
print("Loading finetuned MobileNetV3-Large...")
...
fig = blob_viz.plot_pca_with_cluster_hulls(
    ...
    title=f"MobileNetV3-Large - Threshold: {middle_threshold:.3f}",
)
plt.close(fig)
