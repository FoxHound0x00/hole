# Model: MLP-Mixer-B/16 (requires timm library: pip install timm)
import os
import torch
...
MODEL_PATH = "../finetune/mixer_b16_cifar10.pth"
OUTPUT_DIR = "hole_outputs/mixer_b16"
...
# Load model
print("Loading finetuned MLP-Mixer-B/16...")
model = timm.create_model('mixer_b16_224.goog_in21k_ft_in1k', pretrained=False, num_classes=10)
...
fig = blob_viz.plot_pca_with_cluster_hulls(
    ...
    title=f"MLP-Mixer-B/16 - Threshold: {middle_threshold:.3f}",
)
plt.close(fig)
