...
MODEL_PATH = "../finetune/mbv3s_cifar10.pth"
OUTPUT_DIR = "hole_outputs/mbv3s"
...
# Load model
print("Loading finetuned MobileNetV3-Small...")
...
fig = blob_viz.plot_pca_with_cluster_hulls(
    ...
    title=f"MobileNetV3-Small - Threshold: {middle_threshold:.3f}",
)
plt.close(fig)
