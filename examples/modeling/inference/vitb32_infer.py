# Model: ViT_B_32_Weights.IMAGENET1K_V1
import os
import torch
...
MODEL_PATH = "../finetune/vitb32_cifar10.pth"
OUTPUT_DIR = "hole_outputs/vitb32"
...
# Load model
print("Loading finetuned ViT-B/32...")
...
fig = blob_viz.plot_pca_with_cluster_hulls(
    ...
    title=f"ViT-B/32 - Threshold: {middle_threshold:.3f}",
)
plt.close(fig)
