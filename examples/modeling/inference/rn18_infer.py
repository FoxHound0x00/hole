...
MODEL_PATH = "../finetune/rn18_cifar10.pth"
OUTPUT_DIR = "hole_outputs/rn18"
...
# Load model
print("Loading finetuned ResNet18...")
...
# Register hook on the avgpool layer (before fc)
...
fig = blob_viz.plot_pca_with_cluster_hulls(
    ...
    title=f"ResNet18 - Threshold: {middle_threshold:.3f}",
)
plt.close(fig)
