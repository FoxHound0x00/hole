# Model: ConvNeXt-Base Fine-tuning with Transformers Trainer
import torch
...
training_args = TrainingArguments(
    output_dir="./convnext_base_checkpoints",
...
torch.save(model.model.state_dict(), 'convnext_base_cifar10.pth')
print("Model saved!")
