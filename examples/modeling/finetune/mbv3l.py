# Model: MobileNetV3-Large Fine-tuning with Transformers Trainer
import torch
...
training_args = TrainingArguments(
    output_dir="./mobilenet_v3_large_checkpoints",
...
torch.save(model.model.state_dict(), 'mobilenet_v3_large_cifar10.pth')
print("Model saved!")
