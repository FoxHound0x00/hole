# Model: ConvNeXt-Large Fine-tuning with Transformers Trainer
import torch
...
class ConvNeXtForCIFAR(nn.Module):
    def __init__(self):
        ...
        self.model.classifier[2] = nn.Linear(self.model.classifier[2].in_features, 10)
...
training_args = TrainingArguments(
    output_dir="./convnext_large_checkpoints",
...
torch.save(model.model.state_dict(), 'convnext_large_cifar10.pth')
print("Model saved!")
