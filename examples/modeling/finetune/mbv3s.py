# Model: MobileNetV3-Small Fine-tuning with Transformers Trainer
import torch
...
class MobileNetForCIFAR(nn.Module):
    def __init__(self):
        super().__init__()
...
training_args = TrainingArguments(
    output_dir="./mobilenet_v3_small_checkpoints",
...
torch.save(model.model.state_dict(), 'mobilenet_v3_small_cifar10.pth')
print("Model saved!")
