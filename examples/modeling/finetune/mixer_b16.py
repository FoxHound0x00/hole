# Model: MLP-Mixer-B/16 Fine-tuning with Transformers Trainer
import torch
...
class MixerForCIFAR(nn.Module):
    def __init__(self):
        super().__init__()
        self.model = timm.create_model('mixer_b16_224.goog_in21k_ft_in1k', pretrained=True, num_classes=10)
...
training_args = TrainingArguments(
    output_dir="./mixer_b16_checkpoints",
...
print(f"\nTraining MLP-Mixer-B/16...")
trainer.train()

test_results = trainer.evaluate(test_dataset)
print(f"Test Results: {test_results}")

torch.save(model.model.state_dict(), 'mixer_b16_cifar10.pth')
print("Model saved!")
