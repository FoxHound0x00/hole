"""
ResNet-50 fine-tuning on CIFAR-10 using HuggingFace Transformers
...
if __name__ == "__main__":
    ...
    # Save model
    trainer.save_model("./resnet50_cifar10_finetuned")
    print("\nModel saved to ./resnet50_cifar10_finetuned")
