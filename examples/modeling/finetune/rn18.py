# Model: ResNet-18 Fine-tuning with Transformers Trainer
import torch
...
training_args = TrainingArguments(
    output_dir="./resnet18_checkpoints",
...
print(f"\nTraining ResNet-18 on CIFAR-10 with Transformers Trainer...")
...
torch.save(model.model.state_dict(), 'resnet18_cifar10.pth')
